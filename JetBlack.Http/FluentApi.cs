...
namespace JetBlack.Http
{
    ...
    {
        public static HttpServer AddRoute(
        ...
        public static HttpServer AddMiddleware(
            this HttpServer server,
        ...
        public static HttpServer ConfigureRouter(
            this HttpServer server,
            Action<IHttpRouter> configure)
        {
            configure(server.Router);
            return server;
        }

        public static HttpServer ConfigureMiddleware(
            this HttpServer server,
